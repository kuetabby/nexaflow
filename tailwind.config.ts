...
module.exports = {
  ...
  theme: {
    ...
    // background: linear-gradient(180deg, #385AD3 0%, #0066A6 100%);
    ...
    extend: {
      ...
      backgroundImage: () => ({
        "NexaFlow-primary":
          "linear-gradient(112deg, #0066A6 -25.96%, #FF1BC6 37.55%, #FFF7C6 79.89%)",
        "NexaFlow-secondary":
          "linear-gradient(180deg, #C5D1FF 0%, #385AD3 100%)",

        // "chr-primary": "linear-gradient(152.64deg, #0066A6 0%, #385AD3 100%)",
        // "chr-primary-transparent":
        //   "linear-gradient(152.64deg, rgba(36, 123, 225, 0.5) 0%, rgba(0, 255, 71, 0.5) 100%)",
        // "chr-secondary": "linear-gradient(152.64deg, #385AD3 0%, #0066A6 100%)",
...
// border-image-source: linear-gradient(152.64deg, #0066A6 0%, #385AD3 100%);
